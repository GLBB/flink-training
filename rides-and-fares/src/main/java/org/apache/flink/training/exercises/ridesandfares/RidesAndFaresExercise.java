...
public class RidesAndFaresExercise {
    ...
    public static class EnrichmentFunction
        ...
        public void open(Configuration config) throws Exception {
            ValueStateDescriptor<TaxiRide> taxiRideStateDesc =
                new ValueStateDescriptor<>("taxiRideValueState", Types.POJO(TaxiRide.class));
            taxiRideValueState = getRuntimeContext().getState(taxiRideStateDesc);
            
            ValueStateDescriptor<TaxiFare> fareStateDesc = 
                new ValueStateDescriptor<TaxiFare>("fareStateDesc", Types.POJO(TaxiFare.class));
            taxiFareValueState = getRuntimeContext().getState(fareStateDesc);
        ...
        public void flatMap1(TaxiRide ride, Collector<RideAndFare> out) throws Exception {
            ...
            if (fare == null) {
                ...
                RideAndFare rideAndFare = new RideAndFare(ride, fare);
